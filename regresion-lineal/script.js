...
async function getData() {
    ...
    var datosLimpios = datosCasas.map(casa => ({precio: casa.Precio, cuartos: casa.NumeroDeCuartosPromedio }))
...
async function verCurvaInferencia() {
    ...
    tfvis.render.scatterplot(
        ...
        {values: [puntosOriginales, puntosPrediccion], series: ['original', 'predicciones']},
        {
            xLabel: 'Cuartos',
            yLabel: 'Precio',
            height: 300
